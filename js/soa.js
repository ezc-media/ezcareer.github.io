$(document).ready(function () {
  ...
  const course_name_des =
    "北美精算师协会 Society of Actuaries 即 SOA ，北美精算师证书是世界 上具权威性，规模大，拥有会员多的北美精算师协会认证的高端财会证书。";
  const price_origin = "1100";
  const price_discount = "799";
  const course_open_date = "待定";
  const course_link =
    "https://ezcareer.shop/collections/2020/products/2020-1-soa";
  const course_points = [
    {
      title: "一个月取双证",
      des: "P+FM",
  ...
  const target_group = [
    {
      title: "没有学历专业要求",
      des:
        "一般对数学, 精算, 经济, 金融, 统计等感兴趣的在读生, 毕业生都可以报考. ",
    },
  ];

  const hot_comps_data = [
    {
      src: assets_route + "images/courses/SOA/comp-1.png",
    },
    {
      src: assets_route + "images/courses/SOA/comp-2.png",
    },

    {
      src: assets_route + "images/courses/SOA/comp-3.png",
    },

    {
      src: assets_route + "images/courses/SOA/comp-4.png",
    },

    {
      src: assets_route + "images/courses/SOA/comp-5.png",
    },
  ];

  const video_info = { src: "https://www.youtube.com/watch?v=DZB46VAIfzc" };

  const teacher_name = ["刘畅"];
